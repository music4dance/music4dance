...
namespace m4dModels.Tests
{
    ...
    public class LogTests
    {
        ...
        public void TestRestoreFromLog()
        {
            ...
            Assert.AreEqual(log.SongReference,SongGuid);

            var song = tester.Dms.FindSong(SongGuid);
            ...
            //var ratings = tester.Dms.DanceRatings.Where(r => r.SongId == SongGuid);
        ...
        public void TestUndoUser()
        {
            ...
            var user = tester.Dms.FindUser("Music4Dance");
            tester.Dms.UndoUserChanges(user,SongGuid);
        ...
        private static SongLog CreatLogEntry(DanceMusicTester tester)
        {
            ...
            log.Initialize(LogString, tester.Dms);
        ...
        private static readonly Guid SongGuid = new Guid("89077001-49c3-47b1-8f0e-e9738ea4c89d");
