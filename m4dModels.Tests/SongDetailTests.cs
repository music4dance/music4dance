...
namespace m4dModels.Tests
{
    ...
    public class SongDetailTests
    {
        ...
        [TestMethod]
        public void LoadingRhettRowDetails()
        {
            ValidateLoadingRowDetails(RHeader, RhettRows, RhettRowsProps);
        }
        ...
        {
            @".Create=	User=dwgray	Time=00/00/0000 0:00:00 PM	Title=(I've Had) The Time of My Life	Artist=Bill Medley & Jennifer Warnes	Album:00=Dirty Dancing Soundtrack	Track:00=1	Length=290377	Tag+=Mambo:Dance|Salsa:Dance|Merengue:Dance|Hustle:Dance	DanceRating=MBO+2	DanceRating=SLS+2	DanceRating=MRG+2	DanceRating=HST+2	DanceRating=SWG+1	DanceRating=LTN+3",
            @".Create=	User=dwgray	Time=00/00/0000 0:00:00 PM	Title=A Namorada	Album:00=Phoenix 2001 Cha#1	Track:00=18	Length=286511	Tag+=Cha Cha:Dance|Male Vocal:Other	DanceRating=CHA+2	Tag+:CHA=International:Style	DanceRating=LTN+1",
            @".Create=	User=dwgray	Time=00/00/0000 0:00:00 PM	Title=Ain't That A Kick In The Head	Artist=Dean Martin	Album:00=Ultra-Lounge 'Wild, Cool & Swingin' Vol. 1	Track:00=1	Length=145355	Tag+=Slow Foxtrot:Dance|Mambo:Dance|Cha Cha:Dance	DanceRating=SFT+2	DanceRating=MBO+2	DanceRating=CHA+2	Tag+:SFT=International:Style	DanceRating=LTN+2	DanceRating=FXT+1",
        };
