...
namespace m4dModels.Tests
{
    ...
    public class CleanupTests
    {
        ...
        private const string SongD =
            @"SongId={9e8317e8-a965-4cd5-8091-b1d08b1cdef2}	.Create=	User=HunterZ	Time=3/17/2014 5:43:50 PM	Title=Bye Bye Blackbird	Artist=Sammy Davis Jr	Tempo=116.0	Time=9/4/2014 8:12:02 PM	.Edit=	User=batch	Time=9/4/2014 8:12:02 PM	.Edit=	User=batch	Time=10/9/2014 12:09:30 PM	DanceRating=SFT+4	.Edit=	User=HunterZ	Time=11/20/2014 11:32:39 AM	Tag+=Foxtrot:Dance	.Edit=	User=batch	Time=11/20/2014 11:32:39 AM	Tag+=Jazz:Music	.Edit=	User=HunterZ	Time=9/4/2014 8:06:58 PM	.Edit=	User=batch	OrderAlbums=1,0	Time=9/4/2014 8:06:58 PM	.Edit=	User=HunterZ	Artist=Sammy Davis Jr	Time=6/16/2014 12:41:48 PM	.Edit=	User=batch	PromoteAlbum:1=	Purchase:1:XS=music.086DC007-0100-11DB-89CA-0019B92A3933	Track:1=36	Album:1=The Great American Song Book	Length=171	Artist=Bye Bye Blackbird	Time=5/21/2014 2:05:46 PM	User=batch	DanceRating=FXT+5	Album:0=The Ultimate Ballroom Album 10	.FailedLookup=-:0";
        ...
        [TestMethod, Ignore]
        public async Task CheckProperties()
        {
            var dms = await DanceMusicTester.CreateServiceWithUsers("Cleanup");
            var s =
