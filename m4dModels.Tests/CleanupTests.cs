...
public class CleanupTests
{
    ...
    public async Task CleanOrphanedVotes()
    {
        ...
        {
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:31 PM	Title=Oyeme	Artist=Monica Naranjo	Tempo=96.0	Album:0=Afro Cubano	DanceRating=RMB+1	.Edit=	User=UserE|P	Time=10/2/2014 1:01:59 PM	Length=	.Edit=	User=UserG|P	Time=11/20/2014 11:29:29 AM	Tag+=Rumba:Dance",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:31 PM	Title=Oyeme	Artist=Monica Naranjo	Tempo=96.0	Album:0=Afro Cubano	DanceRating=RMB+1	.Edit=	User=UserE|P	Time=10/2/2014 1:01:59 PM	Length=	.Edit=	User=batch|P	Time=11/20/2014 11:29:29 AM	Tag+=Rumba:Dance",
            @".Create=	User=UserF|P	Time=6/23/2014 2:02:46 PM	Title=S.O.S.	Artist=Rihanna	.Edit=	User=UserAF|P	Time=07/19/2021 02:30:11	Tag+=East Coast Swing:Dance	DanceRating=ECS+1	.Edit=	User=UserAF|P	Time=12/31/2021 09:15:53	Tag+:ECS=American:Style",
        };

        var expected = new List<string>
        {
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:31 PM	Title=Oyeme	Artist=Monica Naranjo	Tempo=96.0	Album:0=Afro Cubano	DanceRating=RMB+1	Tag+=Rumba:Dance	.Edit=	User=UserE|P	Time=10/2/2014 1:01:59 PM	Length=",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:31 PM	Title=Oyeme	Artist=Monica Naranjo	Tempo=96.0	Album:0=Afro Cubano	DanceRating=RMB+1	Tag+=Rumba:Dance	.Edit=	User=UserE|P	Time=10/2/2014 1:01:59 PM	Length=",
            @".Create=	User=UserF|P	Time=6/23/2014 2:02:46 PM	Title=S.O.S.	Artist=Rihanna	.Edit=	User=UserAF|P	Time=07/19/2021 02:30:11	Tag+=East Coast Swing:Dance	DanceRating=ECS+1	.Edit=	User=UserAF|P	Time=12/31/2021 09:15:53	Tag+:ECS=American:Style",
        };
    ...
    public async Task MergeChunks()
    {
        ...
        var songs = new List<string>
        {
            ...
            @".Create=	User=UserO|P	Time=04/15/2015 15:09:16	Title=Tal Vez Es Amor	Artist=Chayanne	Tag+=Bolero:Dance|Rumba:Dance|Spanish:Other	DanceRating=BOL+1	.Edit=	User=UserO|P	Time=4/16/2015 8:36:33 AM	DanceRating=RMB+1",
            //@".Create=	User=batch|P	Time=4/7/2014 2:02:36 PM	Title=Wonderwall	Artist=Paul Anka	.Edit=	User=UserAF|P	Time=07/19/2021 03:33:54	Tag+=Quickstep:Dance	DanceRating=QST+1	.Edit=	User=UserAF|P	Time=12/31/2021 09:08:57	DanceRating=QST+1	Tag+:QST=International:Style"
        };
        ...
        var expected = new List<string>
        {
            ...
            @".Create=	User=UserO|P	Time=04/15/2015 15:09:16	Title=Tal Vez Es Amor	Artist=Chayanne	Tag+=Bolero:Dance|Rumba:Dance|Spanish:Other	DanceRating=BOL+1	DanceRating=RMB+1",
            //@".Create=	User=batch|P	Time=4/7/2014 2:02:36 PM	Title=Wonderwall	Artist=Paul Anka	.Edit=	User=UserAF|P	Time=07/19/2021 03:33:54	Tag+=Quickstep:Dance	DanceRating=QST+1	DanceRating=QST+1	Tag+:QST=International:Style"
        };
    ...
    public async Task CleanBadBatches()
    {
        ...
        var expected = new List<string>
        {
            @".Create=	User=DWTS|P	Time=04/21/2017 02:49:12	Tag+=DWTS:Other|Episode 5:Other|Season 24:Other|Tango (Ballroom):Dance|United States:Other	DanceRating=TGO+1	Tag+:TGO=Bonner:Other|Sharna:Other	Title=When Can I See You Again?	Artist=Owl City	.Edit=	User=charles|P	Time=28-Nov-2023 03:14:37 PM	DanceRating=TGO+1	Tag+=Tango (Ballroom):Dance",
            @".Create=	User=DWTS|P	Time=04/21/2017 02:49:12	Tag+=DWTS:Other|Episode 5:Other|Season 24:Other|Tango (Ballroom):Dance|United States:Other	DanceRating=TGO+1	Tag+:TGO=Bonner:Other|Sharna:Other	Title=When Can I See You Again?	Artist=Owl City	.Edit=	User=charles|P	Time=28-Nov-2023 03:14:37 PM	DanceRating=TGO+1	Tag+=Tango (Ballroom):Dance	.Edit=	User=batch-s|P	Time=07/23/2017 16:43:48	DanceRating=CHA+1",
            @".Create=	User=UserG|P	Time=3/17/2014 5:45:50 PM	Title=Empty Ballroom Blues	Artist=Johnny Hodges	Tempo=190.0	DanceRating=LHP+1	.Edit=	User=batch|P	Time=5/7/2014 11:36:22 AM	Length=147	Album:0=H as in HODGES, Johnny, Vol. 5	Track:0=2	.Edit=	User=batch-i|P	Time=5/7/2014 3:36:19 PM	Album:0=H as in Hodges, Johnny, Vol. 5	Purchase:0:IS=657547338	Purchase:0:IA=657547326	.Edit=	User=UserE|P	Time=10/1/2014 4:48:39 PM	DanceRating=BBA+1	.Edit=	User=UserG|P	Time=11/20/2014 11:31:54 AM	Tag+=Lindy Hop:Dance	.Edit=	User=batch|P	Time=11/20/2014 11:31:54 AM	Tag+=Jazz:Music	.Edit=	User=UserE|P	Time=11/20/2014 11:31:54 AM	Tag+=Balboa:Dance	.Edit=	User=batch-a|P	Time=12/10/2014 3:51:06 PM	Album:02=Hodge Podge. The Best of the Duke's Men. Vol. 1	Track:02=4	Tag+=Jazz:Music	.Edit=	User=batch-i|P	Time=12/10/2014 3:51:07 PM	Tag+=Jazz:Music	.Edit=	User=batch-x|P	Time=12/10/2014 3:51:07 PM	Album:00=H as in HODGES, Johnny, Vol. 5	Album:03=Essential Jazz Masters	Track:03=6	Tag+=Christian / Gospel:Music|Jazz:Music	.Edit=	User=batch-s|P	Time=1/6/2015 4:40:13 PM	Album:04=Back To Back Jazz Legends	Track:04=4	Purchase:04:SS=0dv0vqOFGMCWbaQWpnkK5a	Purchase:04:SA=3vDTHJCTDzMvoqBJ3yYwxi	Album:05=The Ultimate Jazz Collection	Track:05=3	Purchase:05:SS=09vnZ9XdxOy5OHWvAIfobX	Purchase:05:SA=6ELCSXeTpcVBPJPLJnwlk5	Album:06=The Jeep Is Jumpin'	Track:06=13	Purchase:06:SS=3bim8tHjWdrc5PROKhljtq	Purchase:06:SA=7BibOXgDaQTNBtGEXDAtiw	Album:07=Greatest Jazz Masters	Track:07=33	Purchase:07:SS=12V3Y3rRhmEkjFI94GqlQE	Purchase:07:SA=2whBAgz7wvEElOBNVTPIx3	.Edit=	User=batch-a|P	Time=01/11/2016 18:31:21	Purchase:00:AS=D:B00D467SM0	Purchase:00:AA=D:B00D467RCG	Purchase:00:SS=3vyWeDHAgBpyfHIc9nXEtW	Purchase:00:SA=2OomRtevYQUTU9WoxELEjN	.Edit=	User=batch-e|P	Time=02/10/2016 04:02:42	Tempo=96.6	Danceability=0.7389439	Energy=0.3223345	Valence=0.9614524	Tag+=4/4:Tempo"
        };
    ...
    public async Task CleanBadDanceTags()
    {
        ...
        var songs = new List<string>
        {
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink	Tag+=Paso Doble:Dance|!Waltz:Dance	DanceRating=PDL+1",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink	Tag+=Paso Doble:Dance	DanceRating=PDL+1",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink	Tag+=Tango:Dance",
        };
        ...
        var expected = new List<string>
        {
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink	Tag+=Paso Doble:Dance	DanceRating=PDL+1",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink	Tag+=Paso Doble:Dance	DanceRating=PDL+1",
            @".Create=	User=UserG|P	Time=3/17/2014 5:44:04 PM	Title=So What	Artist=Pink",
        };
    ...
    public async Task PurchasePreservesRealUser()
    {
        ...
        var i = props.FindIndex(p => p.BaseName == "User" && p.Value == "UserBG|P");
        Assert.IsTrue(i >= 0);
