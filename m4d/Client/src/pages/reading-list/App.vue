...
// TODO: Consider being able to turn off google ads for this page
//   and add in some amazon banners
//  Audible versions?
//  Redirect to this page, re-index the site
//  Consider pushing the Book list down from the server
const books: Book[] = [
  {
  ...
  },
  {
    ...
    subtitle:
      "Be the One They Want - What I Wish I Knew When I Started Social Dancing",
    author: "Don Baarns",
    kindle: "https://amzn.to/2SVUQKY",
    paperback: "https://amzn.to/35Z2Xtj",
    review:
      "https://music4dance.blog/2021/06/22/book-review-partner-dance-success/",
    notes:
  ...
  },
  {
    ...
    subtitle:
      "The secret to mastering dance and dancing at the excellent standard you want by",
    author: "Clint Steele",
