export const model = {
  blogEntries: [
    ...
    },
    {
      ...
      description:
        "I’ve cross indexed the <a href='https://www.music4dance.net/song'>music4dance catalog</a> with the <a href='http://the.echonest.com/'>EchoNest database</a> and exposed some new features...",
      oneTime: false,
      crawl: false,
      fullPath:
    ...
    },
    {
      ...
      description:
        'I introduced a bug in the last update of <a href="https://www.music4dance.net">music4dance</a> and then went on vacation.  This is a pretty classic software engineering blunder and I\'m very sorry for the trouble it caused.  The good news is...    OneTime',
      oneTime: false,
      crawl: false,
