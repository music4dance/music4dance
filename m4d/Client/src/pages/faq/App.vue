      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.accordion-1 variant="primary">
            Where can I find songs that work with the dance style I'm currently
            practicing?
          </b-button>
        </b-card-header>
        <b-collapse
          ...
          <b-card-body>
            <b-card-text>
              ...
              <p>
                ...
                >
                  I’m learning to Cha Cha, where is some great music for
                  practicing?</a
                >
                and
                <a
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.accordion-2 variant="primary">
            What dance styles work with the song I'm listening to or a specific
            song that I know of?
          </b-button>
        </b-card-header>
        <b-collapse id="accordion-2" accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <b-card-text>
              <p>
                With the <a href="/home/counter">tempo counter tool</a> you can
                tap out the beat while listening to a song, and we'll show you a
                list of styles that can be danced to the beat you just tapped
                out as well as links to the dance styles' information pages.
              </p>
              <p>
              ...
              <p>
                ...
                and the
                <a
                  href="https://music4dance.blog/music4dance-help/tempo-counter/"
                  >documentation</a
                >
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.accordion-3 variant="primary"
            >Why should I sign up with Music4Dance?</b-button
          >
        </b-card-header>
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.accordion-5 variant="primary">
            I'm a competition Ballroom dancer, how can music4dance help me find
            music?
          </b-button>
        </b-card-header>
          ...
          <b-card-body>
            <b-card-text>
              <p>
                ...
                >
                page and see the list of the different competition categories
                and the dance/song requirements for several organizations that
                publish competition rules.
              </p>
              <p>
                If you would like more information check out our related blog
                post.
                ...
                >
                  I'm a competition ballroom dancer, can I find practice songs
                  that are a specific tempo?</a
                >
              </p>
            </b-card-text>
          </b-card-body>
      ...
      <b-card no-body class="mb-1">
        <b-card-header header-tag="header" class="p-1" role="tab">
          <b-button block v-b-toggle.accordion-6 variant="primary">
            I want to find a great song for my first dance at my wedding, where
            should I look?
          </b-button>
        </b-card-header>
        <b-collapse id="accordion-6" accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <b-card-text>
              <p>
                Check out the
                <a href="/dances/wedding-music">wedding page</a> for information
                to help you get started, or you can go to the
                <a href="/song/advancedsearchform">advanced search</a> page and
                look for songs that are tagged as First Dance and/or Wedding.
              </p>
              <p>
                If you would like more information check out our related blog
                posts.
                ...
                >
                  Wedding Music Part II: We’re learning to Rumba, help us find a
                  good song for our first dance</a
                >
              </p>
            </b-card-text>
          </b-card-body>
      ...
      <b-card no-body class="mb-1">
        ...
        <b-collapse id="accordion-7" accordion="my-accordion" role="tabpanel">
          <b-card-body>
            <b-card-text>
              <p>
                If you are not finding the answer to your question here or wish
                to give us feedback on any part of the site please contact us at
                <a href="mailto:info@music4dance.net">info@music4dance.net</a>
                or through our
                <a href="https://music4dance.blog/feedback/">feedback form</a>.
              </p>
