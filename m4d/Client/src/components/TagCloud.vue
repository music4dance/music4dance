    ...
    <div>
        <div class="row" style="margin-bottom: .5rem">
            ...
            <div style='width:250px' class='mx-auto col-sm'>
                <b-form-input id='strictness' v-model='filter' type='range' min='2' max='10' step='1' ></b-form-input>
                <label for='strictness' class='d-flex justify-content-between' style="margin-bottom: 0; margin-top: -.75rem">
...
export default class TagCloud extends Vue {
    ...
    private get tagBuckets(): TagBucket[] {
        ...
        const tags = this.tags.filter((t) => active.includes(t.category.toLowerCase()));
