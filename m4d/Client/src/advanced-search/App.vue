  ...
  <page id="app">
    ...
    <b-form id="advanced-search" @submit="onSubmit" @reset="onReset" novalidate>
      ...
      <b-form-group label="Dances:">
        <div style="border: 1px solid #ced4da; boder-radius: .25rem">
          <dance-selector
            :danceList="danceList"
            v-model="dances"></dance-selector>
      ...
      <b-form-group label="Include Tags:">
        <tag-category-selector
          ...
          v-model="includeTags"></tag-category-selector>
      </b-form-group>
      ...
      <b-form-group label="Exclude Tags:">
        <tag-category-selector
          ...
          searchLabel="Search Tags"
          emptyLabel="No more tags to choose"
          v-model="excludeTags"></tag-category-selector>
      </b-form-group>
      ...
      <b-form-group id="activity-group" label="My Activity:" label-for="activity">
        <b-form-select
          id="activity"
          v-model="activity"
          :options="activities"
      ...
      <b-form-group id="services-group" 
        class="mx-2 mb-2" 
        label="Available on:" 
        label-for="services">
      ...
      <b-form-group id="bonuses-group"
        class="mx-2 mb-2"
        label="Bonus content:"
        label-for="bonuses">
        <b-form-checkbox-group v-model="bonuses" id="bonuses">
          <b-form-checkbox value="P">Not found in any publisher catalog</b-form-checkbox>
          <b-form-checkbox value="D">Not categorized by dance</b-form-checkbox>
        </b-form-checkbox-group>
      ...
      <b-form-group id="sort-group" label="Sort By:" label-for="sort">
        <b-form-select
          ...
          required
        ></b-form-select>
        <b-form-radio-group id="sort-order" v-model="order" name="sort-order" class="mt-2">
          <b-form-radio value="asc">Ascending (A-Z, Slow-Fast, Newest-Oldest)</b-form-radio>
          <b-form-radio value="desc">Descending (Z-A, Fast-Slow, Oldest-Newest)</b-form-radio>
        </b-form-radio-group>
      </b-form-group>
...
export default class App extends Vue {
    ...
    private get songFilter(): SongFilter {
      const danceQuery = DanceQuery.fromParts(
        this.dances, this.danceConnector === 'all', this.danceInferred);
      const userQuery = UserQuery.fromParts(this.activity ? this.activity : undefined);
