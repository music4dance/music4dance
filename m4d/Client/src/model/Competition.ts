...
@jsonObject export class CompetitionCategory  {
...
@jsonObject export class CompetitionGroup  {
    @jsonMember public name!: string;
    @jsonArrayMember(CompetitionCategory) public categories!: CompetitionCategory[];
}

@jsonObject export class CompetitionGroupModel  {
