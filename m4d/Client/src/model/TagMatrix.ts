...
@jsonObject export class TagColumn {
    @jsonMember public title!: string;
    @jsonMember public tag!: string;
}

@jsonObject export class TagRowBase {
    @jsonArrayMember(Number) public counts!: number[];
}

@jsonObject export class TagRow extends TagRowBase {
...
@jsonObject export class  TagRowType extends TagRowBase {
...
@jsonObject export class  TagRowGroup extends TagRowBase {
...
@jsonObject export class TagMatrix {
