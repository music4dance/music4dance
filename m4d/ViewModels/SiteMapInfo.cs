                    ...
                    Entries = new List<SiteMapEntry>
                    {
                        ...
                        new SiteMapEntry
                        {
                            ...
                            Children = new List<SiteMapEntry>
                            {
                                ...
                                new SiteMapEntry {Title = "Farewell to Rio 2016, but we'll always have The Samba", Reference = "blog/farewell-to-rio-2016-but-well-always-have-the-samba/", Description="Now that the 2016 <a href='https://www.olympic.org'>Olympics</a> are over and the <a href='https://www.paralympic.org/'>Paralympics</a> are wrapping up,"},
                                new SiteMapEntry {Title = "Dancing With The Stars, Revisited", Reference = "blog/dancing-with-the-stars-revisited/", Description="I use this show and other as a source for new music, but that biases things.."},
