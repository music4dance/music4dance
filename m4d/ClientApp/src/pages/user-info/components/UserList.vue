...
<template>
  <div>
    ...
    <MustRegister
      ...
      title="You must be registered and logged in to view other users' profiles. Note that if they have chosen to remain anonymous, no profile information will be shown, but you will be able to see their song lists."
    ...
    <template v-else>
      ...
      <div>
        ...
        <p>
          The User Song List feature is still under development. We are considering including lists
          of dance styles that the user has tagged or possibly including lists of arbitrary tags.
          Please
        ...
        <p v-if="model.isAnonymous">
          ...
          to how music4dance is set up, but we also very much want to respect our member's privacy.
          So we're obscuring user names for member who chose to remain anonymous. Since full privacy
          was the default setting for members who signed up for most of the existence of the site
          there are most likely many members who just left this as the default. If you (or a friend)
          are such a person, please consider going to your
          <a href="/identity/account/manage">profile</a> and changing your privacy setting to allow
          other users to see your information. The only information that we currently share is your
          username in the context of lists like this and in the song details where we show the
          changes that each user makes to a song. If we gather additional information in the future
          you are welcome to not participate or change your privacy settings at that time. In
          addition, if you would like to change your user name to something else, please
          <a href="https://music4dance.blog/feedback/">contact us</a> with your preferred user name
