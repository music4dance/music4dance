...
var editor = function () {
    ...
    var logoFromEnum = function (e) {
        var ret = null;
        switch (e) {
            case 1: ret = '/images/icons/amazon-logo.png';
                break;
            case 2: ret = '/images/icons/itunes-logo.png';
                break;
            case 3: ret = '/images/icons/spotify-logo.png';
                break;
        }
    ...
    var Rating = function (data, parent) {
        ...
        self.voteImage = ko.pureComputed(function () {
            ...
            return '/images/icons/dance-' + img + 'icon.png';
        }, this);
    ...
    var Song = function (data) {
        ...
        self.voteImage = ko.pureComputed(function () {
            ...
            return '/images/icons/heart-' + img + 'icon.png';
        }, this);
