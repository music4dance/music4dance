$(document).ready(function () {
    ...
    var MusicService = function() {
        ...
        self.likeUrl = ko.pureComputed(function() {
            ...
            return '/images/icons/dance-' + type + 'icon.png';
        });
    ...
    var updateLike = function (item, like, type) {
        ...
        img.prop('src', '/images/icons/' + type + voteOpts.img + '-icon.png');
    };
    ...
    $('#dance-modal-like').click(function(event) {
        ...
        var data = JSON.stringify({ 'dance': viewModel.danceId(), 'like': like });
    ...
    $('.toggle-like').click(function (event) {
        ...
        var data = JSON.stringify({ 'dance': dance, 'like': like });
        $.ajax({
            method: 'PUT',
