...
namespace m4dModels.Tests
{
    ...
    public class MusicServiceTests
    {
        ...
        public void GetPurchaseLink()
        {
            ...
            CheckLink('X', null, "music.5F058400-0100-11DB-89CA-0019B92A3933", @"http://music.xbox.com/Track/5F058400-0100-11DB-89CA-0019B92A3933?partnerID=Music4Dance?action=play");
        }
