namespace m4d.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<m4d.Context.DanceMusicContext>
    {
        ...
        private static string[] _editUsers = new string[] { "ajy", "SalsaSwingBallroom", "SandiegoDJ", "UsaSwingNet", "LetsDanceDenver", "SteveThatDJ", "JohnCrossan", "WaltersDanceCenter", "breanna", "buzzle", "michelleds"};
    }
}
